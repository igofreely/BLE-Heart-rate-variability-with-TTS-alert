...
public class DeviceServicesActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final EditText etOne= (EditText) findViewById(R.id.editView001);
        BleService.editedtext=etOne.getText().toString();
        etOne.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                BleService.editedtext=s.toString();
            }
        });
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(TAG, "onClick serviceListener: "+tv.getText().toString());
                if (serviceListener == null)
                    return;
